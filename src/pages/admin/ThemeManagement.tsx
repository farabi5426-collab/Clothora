    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-[#ffffff60] uppercase tracking-widest">Manage your storefront's dynamic theme</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {THEMES.map((theme) => {
          ...
          return (
            ...
            >
              <div 
                className="h-32 p-4 flex flex-col justify-end relative overflow-hidden border-b border-[#ffffff15]"
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-black uppercase tracking-widest text-white">{theme.name}</h3>
